...
class Program
{
    ...
    {
        var Person1 = new Person("Ilya", "Rikshin", DateTime.Now);
        var Person2 = new Person("Nix", "Megahasrosh", DateTime.Now);

        var date1 = DateTime.Now;
        var date2 = new DateTime(2004, 09, 30);
        ...
        student.Exam = new Exam[] { new Exam("Deutschland", 4, date3) };
        student.Group = 10;

        student.AddExams(new Exam("OAIP", 3, date1), new Exam("TRiZDB", 5, date2));

        student2.AddExams(new Exam("RPM", 5, date1), new Exam("Psychology", 5, date2));
